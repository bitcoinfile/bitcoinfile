...
public:
    CMainParams() {
		...
		consensus.nBIFIForkHeight					=	501225;
		consensus.powLimit							=	uint256S("00000000ffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
		consensus.powBIFILimit						=	uint256S("0000ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
		consensus.powBIFI501225Limit				=	uint256S("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
		consensus.nPowTargetTimespan				=	(14 * 24 * 60 * 60); // two weeks
		consensus.nPowTargetSpacing					=	(10 * 60);

		consensus.nBifiDifficultyAdjustmentInterval =	144;
		consensus.nBifiPowTargetSpacing				=	(5 * 60);
		...
		checkpointData = (CCheckpointData) {
            {
				...
				{501225, uint256S("0x00a1f3a31ce3d43a576af94a8d78f1b53c5ab37fe730974cf243d16c02c77840")},
				{501226, uint256S("0x004987a2fa3aa55a90adbdce5883d7b3e7f42869fda140a9e829a092f1d17700")},
            }
        };
